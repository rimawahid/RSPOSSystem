 ...
 * @author USER
 */
public class AddCustomersApp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bg.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 240, 250, -1));
...
//        new AddCustomersApp().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddCustomersApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
