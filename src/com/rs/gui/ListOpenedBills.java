 ...
 * @author USER
 */
public class ListOpenedBills extends javax.swing.JFrame {

    /**
     * Creates new form ListOpenedBills
     */
    public ListOpenedBills() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        listSales = new javax.swing.JLabel();
        ...
        jLabel1.setText("LIst openeed");
        bg.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 180, 270, -1));
        ...
        jLabel2.setText("List Opened Bills");
        jLabel2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        bg.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 120, 280, 30));

        listSales.setFont(new java.awt.Font("Corbel", 0, 20)); // NOI18N
        listSales.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/icons8-product-24.png"))); // NOI18N
        listSales.setText("List Sales");
        listSales.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        listSales.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                listSalesMouseClicked(evt);
            }
        });
        bg.add(listSales, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 120, 280, 30));
        ...
        bg.add(listPurchase, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 260, 1560, 520));
...
//        s.setNote(purchasesTable.getValueAt(row, 3).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListOpenedBills.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel listSales;
