...
public class PaymentReport extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        paymentTable.setFont(new java.awt.Font("Calibri", 0, 18)); // NOI18N
        paymentTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Invoice", "Date", "Paid by", "Amount"
            }
        ));
    ...
    private void getAllProduct() {
        ...
        String[] columnNames = {"Invoice","Date","Pay Method",  "Grand Total"};
        Object[][] data = new Object[salesPos.size()][4];
        for (int i = 0; i < salesPos.size(); i++) {
            POS s = salesPos.get(i);
            Object[] o = {s.getInvoice(),s.getSellDate(),s.getPayMethod(), s.getTotalPayAmountVlaue()};
            for (int j = 0; j < 4; j++) {
                data[i][j] = o[j];
            }
        }
